...
function OperationJsPost() {
    ...
    $operationJs = "
        ...
        $(document).ready(function() {
            ...
            var countInput = [5, 65, 11, 18, 26, 34, 42, 50, 58, 63];
            var countInputObj = [];
            ...
            calcValue('input:eq(16)', 'input:eq(17)', 'input:eq(18)');
            calcValue('input:eq(24)', 'input:eq(25)', 'input:eq(26)');
            calcValue('input:eq(32)', 'input:eq(33)', 'input:eq(34)');
            calcValue('input:eq(40)', 'input:eq(41)', 'input:eq(42)');
            calcValue('input:eq(48)', 'input:eq(49)', 'input:eq(50)');
            calcValue('input:eq(56)', 'input:eq(57)', 'input:eq(58)');
            ...
            getSlideValue('#operation14', '#factory');
            getSlideValue('#operation15', '#production');
            getSlideValue('#operation22', '#factory');
            getSlideValue('#operation23', '#production');
            getSlideValue('#operation30', '#factory');
            getSlideValue('#operation31', '#production');
            getSlideValue('#operation38', '#factory');
            getSlideValue('#operation39', '#production');
            getSlideValue('#operation46', '#factory');
            getSlideValue('#operation47', '#production');
            getSlideValue('#operation54', '#factory');
            ...
            $('input[type=text]').not('#operation66').change(function() {
                 ...
                 $('input:eq(66)').val( countValue.toFixed(2) );
            });
        });
    ";
